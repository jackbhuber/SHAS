...
a <- plot(results.rsm, type = 'trace', which.items = 30,
     main = "", par.settings = simpleTheme(lty=1:4,lwd=2),
     auto.key=list(points=FALSE,lines=TRUE, columns=4))
direct.label(a, 'top.points')
```

```{r rsm-item-plot-b, fig.cap='Category Response Curves for the Rating Scale Model'}
# RSM ITEM PLOTS
library(directlabels)
b <- plot(results.rsm, type = 'trace', which.items = 9,
     main = "", par.settings = simpleTheme(lty=1:4,lwd=2),
     auto.key=list(points=FALSE,lines=TRUE, columns=4))
