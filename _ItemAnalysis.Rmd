...
all         <- read_csv("/Users/jack_huber/Documents/MY RESEARCH/SHAS Validity/data/all.csv")
items       <- read.csv("/Users/jack_huber/Documents/MY RESEARCH/SHAS Validity/data/items.csv")
ext_items   <- read.csv("/Users/jack_huber/Documents/MY RESEARCH/SHAS Validity/data/ext_items.csv")
int_items   <- read.csv("/Users/jack_huber/Documents/MY RESEARCH/SHAS Validity/data/int_items.csv")
# Datasets with listwise deletion
all_l       <- read_csv("/Users/jack_huber/Documents/MY RESEARCH/SHAS Validity/data/all_l.csv")
items_l     <- read.csv("/Users/jack_huber/Documents/MY RESEARCH/SHAS Validity/data/items_l.csv")
ext_items_l <- read.csv("/Users/jack_huber/Documents/MY RESEARCH/SHAS Validity/data/ext_items_l.csv")
int_items_l <- read.csv("/Users/jack_huber/Documents/MY RESEARCH/SHAS Validity/data/int_items_l.csv")
...
# SUMMARIZE DATA
options(digits=2)
knitr::kable(stats, caption = "Items Statistics", booktabs = TRUE, digits=2)
