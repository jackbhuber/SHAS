...
```{r rsm-items}
knitr::kable(items.rsm2, digits = 2, caption = "Rating Scale Model Item Parameters for Spiritual Harm and Abuse Items")
```
...
```{r rsm-item-fit}
knitr::kable(misfits, digits = 2, caption = "Rating Scale Model (RSM) - Misfitting Items", row.names = FALSE)
```
...
knitr::kable(M2(results.rsm, type = "C2"))
```
