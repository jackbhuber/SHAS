...
hist(items.rsm2$c, breaks=50, main = NULL, col="red", xlab="Lifetime Exposure to Spiritual Abuse",)
```
...
```{r rsm-item-info}
plot(results.rsm, type='infotrace', which.item = c(1,2,3,4,5,6), facet_items=T, 
...
The obtained RMSEA value = .092 (95% CI[.092, .093]) suggests that data do not fit the model reasonably very well using suggested cutoff values of RMSEA <= .06 as suggested guidelines for assessing fit. The CFI = .953 meets the recommended .95 threshold.