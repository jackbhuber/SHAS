...
\hypersetup{
  pdftitle={Validation of the Spiritual Harm and Abuse Scale with the Rasch Measurement Model},
...
\title{Validation of the Spiritual Harm and Abuse Scale with the Rasch Measurement Model}
...
The proportion of variance explained by the Rasch model was .23. If the unidimensionalty assumption is safely met if the Rasch model explains 20\% of the variance in the data \citep{Reckase1979}, then the SHAS data meet this criterion.
...
\includegraphics{_main_files/figure-latex/rsm-more-plots-1.pdf} \includegraphics{_main_files/figure-latex/rsm-more-plots-2.pdf}

\textbf{Item Parameters and Fit Statistics}. We report RSM item parameters and fit statistics for the SHAS items in Table \ref{tab:rsm-item-tbl}. The first column reports the severity parameters, and we have sorted the items by the severity parameter to facilitate comparison between items.
...
\begin{longtable}[t]{>{\raggedright\arraybackslash}p{11cm}cccc}
\caption{\label{tab:rsm-item-tbl}Estimated Item Parameters for the Rating Scale Model and Item Chi-Square Fit Statistics}\\
\toprule
\multicolumn{1}{c}{ } & \multicolumn{2}{c}{Item Parameters} & \multicolumn{2}{c}{Fit Statistics} \\
\cmidrule(l{3pt}r{3pt}){2-3} \cmidrule(l{3pt}r{3pt}){4-5}
  & xsi & se.xsi & Outfit & Infit\\
\midrule
\endfirsthead
...
\bottomrule
\endlastfoot
EQ22 - Expected to follow pastor/leader rules re: dating/marriage/sex & -0.42 & 0.02 & 1.21 & 1.26\\
...
IQ77 - Anger upon reflecting on negative religious experiences & -0.13 & 0.02 & 0.71 & 0.69\\
\addlinespace
EQ39 - Made to feel shame over natural sexual desires (not actions) & -0.12 & 0.02 & 1.13 & 1.13\\
IQ80 - Feeling isolated & -0.11 & 0.02 & 0.94 & 0.86\\
IQ69 - Lack of spiritual direction/purpose & -0.05 & 0.02 & 1.34 & 1.12\\
IQ71 - Avoiding religious activities/settings to reduce distressing feelings & -0.04 & 0.02 & 0.93 & 0.92\\
...
IQ76 - Feeling I wasted years of my life in a church/set of beliefs & 0.15 & 0.02 & 1.07 & 1.09\\
EQ32 - Feeling unable to express unhappiness & 0.17 & 0.02 & 0.91 & 0.88\\
EQ36 - Mental/physical problems interpreted as spiritual/moral weakness & 0.18 & 0.02 & 0.84 & 0.82\\
\addlinespace
EQ61 - Developmentally-inappropriate/anxious end times descriptions taught to young children & 0.18 & 0.02 & 1.11 & 1.14\\
IQ74 - Sadness over the loss of my faith/religious community & 0.19 & 0.02 & 1.33 & 1.18\\
EQ45 - Developmentally-inappropriate/anxious Hell/Satan/demons taught to young children & 0.20 & 0.02 & 1.09 & 1.11\\
IQ78 - A lack of self-worth & 0.20 & 0.02 & 1.08 & 1.02\\
...
EQ7 - Pastor speaking on God's behalf & 0.45 & 0.02 & 1.37 & 1.26\\
EQ58 - Terror/horror used to motivate religious decisions & 0.45 & 0.02 & 0.91 & 0.94\\
\addlinespace
EQ11 - Disagree w/pastor portrayed as evil & 0.47 & 0.02 & 0.82 & 0.85\\
IQ73 - Self-hatred or self-loathing & 0.51 & 0.02 & 1.18 & 1.16\\
EQ29 - Feeling special when in pastor’s good graces; otherwise ignored & 0.52 & 0.02 & 1.11 & 1.08\\
EQ34 - Scripture used to justify physical punishment/severe discipline & 0.53 & 0.02 & 1.21 & 1.17\\
IQ79 - Distrust of God & 0.62 & 0.02 & 1.35 & 1.21\\
\addlinespace
EQ53 - Scripture used to justify abusive parent-child behavior & 0.64 & 0.02 & 0.95 & 1.00\\
EQ51 - Extreme pressure to be pastor/missionary/spiritual leader & 0.67 & 0.02 & 1.41 & 1.39\\
EQ19 - Behavior excessively monitored by pastor/group & 0.69 & 0.02 & 0.86 & 0.93\\
...
\addlinespace
EQ28 - Leadershi/group protecting abusive individuals & 0.76 & 0.02 & 0.92 & 0.90\\
EQ64 - Witnessing women pressured to stay in unfaithful/abusive marriages & 0.77 & 0.02 & 0.99 & 0.99\\
EQ50 - Treated as less than because of my gender & 0.79 & 0.02 & 1.96 & 1.91\\
IQ82 - Having trouble navigating life outside my church/community & 0.80 & 0.02 & 1.17 & 1.16\\
EQ21 - Taught I would risk Hell if left my church/group & 0.83 & 0.02 & 1.31 & 1.39\\
\addlinespace
EQ59 - Pastor/group blame victim for their abuse & 0.87 & 0.02 & 0.75 & 0.81\\
EQ20 - Members pressured to give money despite financial hardship & 0.88 & 0.02 & 1.13 & 1.27\\
EQ62 - Scripture used to justify physical violence & 0.88 & 0.02 & 1.08 & 1.11\\
EQ57 - Developing mental/physical ailments from conforming to group/leader’s expectation & 0.89 & 0.02 & 0.94 & 1.08\\
EQ16 - Church/community abandoning me in difficult time & 0.92 & 0.02 & 1.02 & 1.05\\
\addlinespace
EQ49 - Leadership/group protecting and elevating abusive individuals & 0.92 & 0.02 & 0.88 & 0.92\\
IQ70 - Feeling betrayed by God & 0.95 & 0.02 & 1.38 & 1.27\\
EQ52 - Blamed for harm I suffered rather than blaming who harmed me & 0.98 & 0.02 & 0.79 & 0.88\\
...
EQ31 - Shunned/ignored by pastor/church/group & 1.04 & 0.02 & 1.12 & 1.08\\
EQ23 - Prayer replacing needed medical interventions & 1.19 & 0.02 & 1.06 & 1.09\\
EQ24 - Expected to consult pastor/leader before making non-religious decisions & 1.24 & 0.02 & 1.01 & 1.08\\
EQ26 - Pressured to forgive abuser while abuse was ongoing & 1.26 & 0.02 & 1.37 & 1.30\\
\addlinespace
EQ10 - Asked to give up personal goals by pastor & 1.32 & 0.02 & 1.10 & 1.19\\
EQ65 - Cut off/shunned by more religious family members & 1.33 & 0.02 & 1.30 & 1.26\\
IQ81 - Nightmares about my negative religious experiences & 1.42 & 0.02 & 0.90 & 0.97\\
IQ72 - Feeling as if God harmed me directly & 1.64 & 0.02 & 1.15 & 1.22\\
EQ47 - Medical care being postponed/withheld for religious reasons & 1.94 & 0.03 & 1.12 & 1.16\\*
\end{longtable}

\textbf{Reliability}. The RSM expresses internal consistency reliability as a Rasch person separation. Based on Table X, the SHAS has a high Rasch person separation reliability of .963, indicating that the estimated RSM scale discriminated well between persons with varying severity of spiritual abuse.

The SHAS also has a high Rasch item separation reliability with Rel = .XX, χ2 (XX) = XXXX.X, p \textless{} .XX, implying that the items have a good spread in terms of item ordering and hierarchy.

\begin{verbatim}
[1] 1
\end{verbatim}

\textbf{Item-Person Map}.

\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/rsm-wrightmap-1.pdf}
\caption{\label{fig:rsm-wrightmap}Item-Person Map}
\end{figure}

\textbf{Model-Data Fit}. To assess the overall fit of the model to the item response data we use two statistics. The first is the Root Mean Square Error of Approximation (RMSEA). The suggested cutoff for RMSEA is .06. The second is the CFI. The suggested cutoff for the CFI is .95. Model fit statistics for the SHAS items are presented in Table \ref{tab:rsm-model-fit}.
