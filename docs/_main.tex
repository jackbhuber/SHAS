...
\includegraphics{_main_files/figure-latex/iclust-plot-1.pdf} \includegraphics{_main_files/figure-latex/iclust-plot-2.pdf}
...
Cluster fit =  0.98   Pattern fit =  0.99  RMSR =  0.06 
\end{verbatim}
