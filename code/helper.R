...
# COUNT TOTAL MISSING VALUES FROM THE ENTIRE DATA FRAME
# sum(is.na(items))

# EXPORT DATA FRAME
library("writexl")
write_xlsx(item_stats,"/Users/jack_huber/Documents/MY RESEARCH/SHAS Validity/item_stats.xlsx")

# SUM ROWS INTO A NEW COLUMN (I.E. TOTAL SCORE)
