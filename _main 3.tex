...
In this paper, we use item response theory (IRT) to further validate and enhance the SHAS for clinical and research use. Item response theory can enhance clinical assessments in several ways. First, IRT improves upon ordinal-level sum scores by providing interval-level measures which are more appropriate for statistical analysis. Second, measurements derived from IRT are sample-free, meaning it is possible to estimate a person's level of the latent construct free of the distribution of individual items and to estimate an item's difficulty level free from the distribution of people used in the sample. Third, IRT models allow more in-depth analysis of items. Finally, IRT improves upon single overall reliability coefficients by providing examination of precision across the score continuum.
