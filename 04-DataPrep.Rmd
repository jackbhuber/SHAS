...
## Recode the items
In the survey the response categories ranged from 1 (Never) to 5 (Always). For IRT analysis we subtract 1 from each response so that they range from 0 to 4.
