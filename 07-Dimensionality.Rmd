...
To assess the dimensionality of these items we use exploratory factor analysis and confirmatory factor analysis (CFA) and PCAR.
...
Factor analysis is commonly used to investigate whether item responses are unidimensional. In our use of CFA we used several statistics and fit indices:
