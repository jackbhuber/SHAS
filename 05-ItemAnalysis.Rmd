...
The second assumption is local independence [@EmbretsonReise2000]. This means that any set of items should not share any meaningful correlation once the latent variable has been accounted for (Edwards, Houts, & Cai, 2018).
...
```{r mirt-items, echo=TRUE, message=FALSE, warning=FALSE, include=TRUE}
# ESTIMATE PCM MODEL
library(mirt)
items <- read.csv("data/items.csv")
...
# knitr::kable(ifit, "simple", digits = 2, caption = "Partial Credit Model (PCM) - Item Fit Statistics")
